    ...
    return(
        <div className="editModal glass vertical gap">
            ...
            <div className="horizontal smallGap">
                <label htmlFor="editModal__inputFile" className="editModal__coverButton glass">
            ...
            <div className="horizontal gap editModal__buttons">
                ...
                <button className="glass buttonPadding buttonText" onClick={toggleEditModal}>Cancel</button>
            </div>
        </div>
    )
}
