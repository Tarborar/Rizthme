    ...
    return(
        <div>
            <div className="app__edit glass horizontal">
                <button className='app__editButton glass glassHover center' onClick={toggleFolderModal}>
                    <FontAwesomeIcon icon={faFolderOpen} className='app__icon' />
                </button>
                <button className='app__editButton glass glassHover center' onDragOver={dragOver} onDrop={dragEditFolder}>
                    <FontAwesomeIcon icon={faPenToSquare} className='app__icon' />
                </button>
                <button className='app__editButton glass glassHover center' onDragOver={dragOver} onDrop={dragRemoveFolder}>
